  ...
  <nav class="border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
    ...
    >
      ...
      <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
        ...
        >
          <li>
            <router-link  class="block py-2 px-3 md:p-0 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent" to="/">Home</router-link>
          </li>
          <li>
            <router-link
